...
from app.model_service.train.local.tabular.classification.model import TabularTrainingRequest

#! important code
from app.model_service.train.local.tabular.classification.autogluon_trainer import AutogluonTrainer
...
@router.post("/tabular_classifier/train", tags=["tabular_classifier"])
async def handler(request: TabularTrainingRequest):
    ...
    try:
        ...
        # )
        model  = await trainer.train_async(target, train_path, None, user_model_path)
...
@router.post("/tabular_classifier/predict", tags=["tabular_classifier"])
async def predict(
...
@router.post("/tabular_classifier/accuracy", tags=["tabular_classifier"])
