...
from app.model_service.train.local.object_detection.model import TrainingRequest
from app.model_service.train.local.object_detection.autogluon_trainer import AutogluonTrainer
...
@router.post("/object_detection/train", tags=["object_detection"])
...
@router.post("/object_detection/predict", tags=["object_detection"])
async def predict(
...
@router.post("/object_detection/accuracy", tags=["object_detection"])
