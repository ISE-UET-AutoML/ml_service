...
from app.training_service.image_classifier.model import TrainingRequest
from app.training_service.image_classifier.autogluon_trainer import AutogluonTrainer
