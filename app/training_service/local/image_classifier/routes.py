...
from app.training_service.local.image_classifier.model import TrainingRequest
from app.training_service.local.image_classifier.autogluon_trainer import AutogluonTrainer
...
@router.post("/image_classifier/train", tags=["image_classifier"])
