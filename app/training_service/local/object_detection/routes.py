...
from app.training_service.local.object_detection.model import TrainingRequest
from app.training_service.local.object_detection.autogluon_trainer import AutogluonTrainer
