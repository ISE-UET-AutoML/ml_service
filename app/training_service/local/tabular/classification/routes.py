...
from app.training_service.local.tabular.classification.model import TabularTrainingRequest

#! important code
from app.training_service.local.tabular.classification.autogluon_trainer import AutogluonTrainer
