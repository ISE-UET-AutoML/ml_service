...
from app.training_service.object_detection.model import TrainingRequest
from app.training_service.object_detection.autogluon_trainer import AutogluonTrainer
