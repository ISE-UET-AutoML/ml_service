...
from app.training_service.tabular.classification.model import TrainingRequest

#! important code
from app.training_service.tabular.classification.autogluon_trainer import AutogluonTrainer
