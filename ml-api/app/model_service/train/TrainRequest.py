...
class CloudTrainRequest(SimpleTrainRequest):
    task : str = Field(default="IMAGE_CLASSIFICATION", title="Task name")
    dataset_label_url: str = Field(title="Dataset label URL from Data Service")
    dataset_url : str = Field(title="Dataset URL from S3 generated by Data Service")
