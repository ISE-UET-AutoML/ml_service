...
class TaskPool(BasePool):
    ...
    def terminate_job(self, pid, signal=signal.SIGTERM) -> None:
        self.kill_chill_processes(pid, signal)

    def kill_chill_processes(self, parent_pid, signal=signal.SIGTERM) -> None:
        try:
